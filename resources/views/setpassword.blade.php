                    ...
                    <form method="POST" action="{{route('save_user') }}">
                        ...
                        <input type="hidden" name="country" value="{{$_GET['country']}}">
                                                ...
                                                <div id="pass" >
                                                  ...
                                                  @endif
                                                  <div class="row mb-3">
                                                    <label for="password" style="color: black;" class="col-md-4 col-form-label text-md-end">{{ __('Password') }}</label>
                                                ...
                                                <div class="row mb-3">
                                                    <label name="confirm_password" style="color: black;" class="col-md-4 col-form-label text-md-end">{{ __('Confirm Password') }}</label>
