...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-dark shadow-sm" style="width: 2000px;">
            <div class="container">
    ...
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-1 px-sm-2  bg-dark" style="height: auto;">
